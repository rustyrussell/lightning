...
/* Generated stub for add_to_sketch */
void add_to_sketch(struct routing_state *rstate UNNEEDED, struct chan *chan UNNEEDED)
{ fprintf(stderr, "add_to_sketch called!\n"); abort(); }
...
/* Generated stub for remove_from_sketch */
void remove_from_sketch(struct routing_state *rstate UNNEEDED, struct chan *chan UNNEEDED)
{ fprintf(stderr, "remove_from_sketch called!\n"); abort(); }
...
/* Generated stub for update_node_sketches */
void update_node_sketches(struct routing_state *rstate UNNEEDED,
			  const struct node *node UNNEEDED)
{ fprintf(stderr, "update_node_sketches called!\n"); abort(); }
...
/* Generated stub for update_sketch */
void update_sketch(struct routing_state *rstate UNNEEDED, struct chan *chan UNNEEDED)
{ fprintf(stderr, "update_sketch called!\n"); abort(); }
