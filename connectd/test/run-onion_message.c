...
/* Generated stub for decrypt_enctlv */
bool decrypt_enctlv(const struct pubkey *blinding UNNEEDED,
		    const struct secret *ss UNNEEDED,
		    const u8 *enctlv UNNEEDED,
		    struct pubkey *next_node UNNEEDED,
		    struct pubkey *next_blinding)

{ fprintf(stderr, "decrypt_enctlv called!\n"); abort(); }
/* Generated stub for decrypt_final_enctlv */
bool decrypt_final_enctlv(const tal_t *ctx UNNEEDED,
			  const struct pubkey *blinding UNNEEDED,
			  const struct secret *ss UNNEEDED,
			  const u8 *enctlv UNNEEDED,
			  const struct pubkey *my_id UNNEEDED,
			  struct pubkey *alias UNNEEDED,
			  struct secret **path_id)

{ fprintf(stderr, "decrypt_final_enctlv called!\n"); abort(); }
/* Generated stub for decrypt_obs2_enctlv */
bool decrypt_obs2_enctlv(const struct pubkey *blinding UNNEEDED,
			 const struct secret *ss UNNEEDED,
			 const u8 *enctlv UNNEEDED,
			 struct pubkey *next_node UNNEEDED,
			 struct pubkey *next_blinding)

{ fprintf(stderr, "decrypt_obs2_enctlv called!\n"); abort(); }
/* Generated stub for decrypt_obs2_final_enctlv */
bool decrypt_obs2_final_enctlv(const tal_t *ctx UNNEEDED,
			       const struct pubkey *blinding UNNEEDED,
			       const struct secret *ss UNNEEDED,
			       const u8 *enctlv UNNEEDED,
			       const struct pubkey *my_id UNNEEDED,
...
{ fprintf(stderr, "decrypt_obs2_final_enctlv called!\n"); abort(); }
...
/* Generated stub for fromwire_obs2_onion_message */
bool fromwire_obs2_onion_message(const tal_t *ctx UNNEEDED, const void *p UNNEEDED, struct pubkey *blinding UNNEEDED, u8 **onionmsg UNNEEDED)
{ fprintf(stderr, "fromwire_obs2_onion_message called!\n"); abort(); }
/* Generated stub for fromwire_obs2_onionmsg_payload */
bool fromwire_obs2_onionmsg_payload(const u8 **cursor UNNEEDED, size_t *max UNNEEDED,
			  struct tlv_obs2_onionmsg_payload * record UNNEEDED)
{ fprintf(stderr, "fromwire_obs2_onionmsg_payload called!\n"); abort(); }
/* Generated stub for fromwire_onion_message */
bool fromwire_onion_message(const tal_t *ctx UNNEEDED, const void *p UNNEEDED, struct pubkey *blinding UNNEEDED, u8 **onionmsg UNNEEDED)
{ fprintf(stderr, "fromwire_onion_message called!\n"); abort(); }
/* Generated stub for fromwire_onionmsg_payload */
bool fromwire_onionmsg_payload(const u8 **cursor UNNEEDED, size_t *max UNNEEDED,
			  struct tlv_onionmsg_payload * record UNNEEDED)
{ fprintf(stderr, "fromwire_onionmsg_payload called!\n"); abort(); }
...
/* Generated stub for tlv_obs2_onionmsg_payload_new */
struct tlv_obs2_onionmsg_payload *tlv_obs2_onionmsg_payload_new(const tal_t *ctx UNNEEDED)
{ fprintf(stderr, "tlv_obs2_onionmsg_payload_new called!\n"); abort(); }
/* Generated stub for tlv_onionmsg_payload_new */
struct tlv_onionmsg_payload *tlv_onionmsg_payload_new(const tal_t *ctx UNNEEDED)
{ fprintf(stderr, "tlv_onionmsg_payload_new called!\n"); abort(); }
...
/* Generated stub for towire_obs2_onion_message */
u8 *towire_obs2_onion_message(const tal_t *ctx UNNEEDED, const struct pubkey *blinding UNNEEDED, const u8 *onionmsg UNNEEDED)
{ fprintf(stderr, "towire_obs2_onion_message called!\n"); abort(); }
/* Generated stub for towire_onion_message */
u8 *towire_onion_message(const tal_t *ctx UNNEEDED, const struct pubkey *blinding UNNEEDED, const u8 *onionmsg UNNEEDED)
{ fprintf(stderr, "towire_onion_message called!\n"); abort(); }
...
/* Generated stub for towire_tlvstream_raw */
void towire_tlvstream_raw(u8 **pptr UNNEEDED, struct tlv_field *fields UNNEEDED)
{ fprintf(stderr, "towire_tlvstream_raw called!\n"); abort(); }
...
/* Generated stub for unblind_onion */
bool unblind_onion(const struct pubkey *blinding UNNEEDED,
		   void (*ecdh)(const struct pubkey *point UNNEEDED, struct secret *ss) UNNEEDED,
		   struct pubkey *onion_key UNNEEDED,
		   struct secret *ss)

{ fprintf(stderr, "unblind_onion called!\n"); abort(); }
