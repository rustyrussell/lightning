...
def test_hsmtool_all_commands_work_with_mnemonic_formats(node_factory):
    ...
    test_commands = [
        (["printnodeid", hsm_path], "03653e90c1ce4660fd8505dd6d643356e93cfe202af109d382787639dd5890e87d"),
        (["printcodexsecret", hsm_path, "test"], "cl10testst6cqh0wu7p5ssjyf4z4ez42ks9jlt3zneju9uuypr2hddak6tlqsghuxusm6m6azq"),
...
def test_hsmtool_deterministic_node_ids(node_factory):
    ...
    cmd_line = ["tools/hsmtool", "printnodeid", hsm_path2]
...
def test_bip86_address_type_validation(node_factory):
    ...
    assert bip86_addr['bip86'] in [a.get('bip86') for a in addrs['addresses']]
...
def test_hsmtool_printnodeid(node_factory):
    l1 = node_factory.get_node()

    cmd_line = ["tools/hsmtool", "printnodeid", os.path.join(l1.daemon.lightning_dir, TEST_NETWORK, "hsm_secret")]
