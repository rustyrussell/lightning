...
struct db_query db_postgres_queries[] = {
    ...
    {
         .name = "ALTER TABLE channels ADD COLUMN option_simplified_update INTEGER DEFAULT 0;",
         .query = "ALTER TABLE channels ADD COLUMN option_simplified_update INTEGER DEFAULT 0;",
         .placeholders = 0,
         .readonly = false,
    },
    {
...
// SHA256STAMP:21a016b0b23f1064190dcd25394d1c388cab2db25d5c5ef2f6691ecb5290f1f1
